...
3. Set Banuba token in the sample app [VideoEditor initializer](https://github.com/Banuba-Examples/ve-sdk-react-native-cli-integration-sample/blob/master/ios/AppDelegate.swift#L18).
